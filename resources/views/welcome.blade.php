...
<div class="container mt-3">
    ...
    <div class="row">
        <div class="w-25 p-3 bg-success text-center">
            ...
            <p>
                29-30 апреля 2022 года проводится международная научно-практическая конференция
            ...
            <p>
                ...
                Тел: +998622246134
                Web сайт конференции: <a href="https://conference.ubtuit.uz/">https://conference.ubtuit.uz/</a>
            </p>
            <p>
                ТЕЛЕФОН ДЛЯ ИНФОРМАЦИИ:
                998972116496
                М.Машарипов
                E-mail: <a href="">nauka@ubtuit.uz</a>
            </p>
            <p class="text-white">
                ДЕНЕЖНЫЕ ПЕРЕВОДЫ
        ...
        <div class="w-75 p-1 bg-success">
            <div class="bg-white d-flex text-justify p-2 align-items-center h-100 flex-column">
               <p>
                   ...
                   технологий и коммуникаций Республики Узбекистан 29-30 апреля 2022 года на тему
                   “Информационные технологии, сети и телекоммуникации” ITNT-2022.
               </p>
                <p>
                ...
                <p>
                    Срок подачи документов до 24 апреля 2022 года в электронном варианте на узбекском, русском или английском языках.
                </p>
                <p> Статьи должны бить отправлены на электронный адрес <a href="" class="fw-bold text-black">nauka@ubtuit.uz</a> </p>
            </div>
        </div>
    </div>
</div>
